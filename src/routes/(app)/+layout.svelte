...
{#if showTabs}
	...
	<nav class="tabbar" aria-label="주 메뉴">
		<a class="tab" class:on={onLetters} href="/letters" aria-current={onLetters ? 'page' : undefined}>
		...
		<a class="tab" class:on={!onLetters} href="/" aria-current={!onLetters ? 'page' : undefined}>
			<svg viewBox="0 0 24 24" aria-hidden="true">
				{#if !onLetters}
