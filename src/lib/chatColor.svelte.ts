...
export const CHAT_COLORS: ChatColor[] = [
	...
	{ id: 'sunset', label: '기본', fill: 'linear-gradient(180deg, #f2603f, #ee4360 55%, #d92868)' }, // 주황 → 핑크
	{ id: 'purple', label: '보라', fill: 'linear-gradient(180deg, #7059f5, #9b57e6 50%, #c04fd8)' }, // 보라 → 자주
	{ id: 'ocean', label: '파랑', fill: 'linear-gradient(#3b8af6, #3b8af6)' }, // 단색
	{ id: 'mint', label: '초록', fill: 'linear-gradient(180deg, #3aa757, #14a37f 50%, #0e8f9c)' }, // 초록 → 청록
	{ id: 'graphite', label: '회색', fill: 'linear-gradient(180deg, #7a7a80, #4a4a4f 55%, #2c2c2e)' } // 밝은 회색 → 먹색
];
